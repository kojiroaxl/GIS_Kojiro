...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] id, nama, alamat, gambar, gambar1, no_hp;
    int jumlahdata;
    ...
    private void getlokasi() {
        String url = "https://giskojiro.000webhostapp.com/koneksi.php";
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        no_hp = new String[jumlahdata];
                        gambar = new String[jumlahdata];
                        gambar1 = new String[jumlahdata];
                        ...
                        for (int i = 0; i < jumlahdata; i++) {
                            try {
                                ...
                                gambar1[i] = data.getString("gambar1");
                                ...
                                for (int i=0;i<jumlahdata;i++){
                                    if (marker.getTitle().equals(nama[i])){
                                        if (MarkerD[i]){
                                            ...
                                            DetailActivity.tlfn=no_hp[i];
                                            DetailActivity.gambar=gambar[i];
                                            DetailActivity.gambar1=gambar1[i];
